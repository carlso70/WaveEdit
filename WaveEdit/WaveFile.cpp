...
static int getLittleEndian4(unsigned char * src) {
...
void WaveFile::add_sample(int sample) {
...
void WaveFile::tone(int frequency, int msecs) {
	// Generate data
...
WaveFile* WaveFile::multiply_freq(double k, int durationms)
{
...
WaveFile *WaveFile::echo(float echoAmount, float delayms)
{
